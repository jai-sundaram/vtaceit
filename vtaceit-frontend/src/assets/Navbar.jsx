        ...
        <div>
           ...
           bg-vtorange drop-shadow-md">
            <ul className = "flex flex-row gap-10 font-semibold text-base">
                ...
                <Link to="/none"><li className = "float-left ml-165 mt-3 text-2xl text-white hover:underline">Home</li></Link>
                <Link to="/search"><li className = "text-2xl mt-3 text-white hover:underline">Search</li></Link>
                <Link to="/home"><li className = "text-2xl mt-3 text-white hover:underline">All Guides</li></Link>
