...
const Results = () => {
    ...
    const[showResultsMessage, setShowResultsMessage] = useState('')
    ...
    return (
        <div>
            ...
            <div className = " bg-white drop-shadow-md">
                <div className = " relative w-50 font-medium h-20 rounded-lg  float-left ml-70 mt-30     ">
                    <div
